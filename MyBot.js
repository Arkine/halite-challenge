...
game.initialize().then(async () => {
    ...
    const gridDensityMap = helpers.gridDensityMap(10, 10, gameMap);

    // const spawnLocation = me.shipyard.position;
    // logging.info(`spawn location: ${JSON.stringify(game.gameMap, null, 2)}`);


    // As soon as you call "ready" function below, the 2 second per turn timer will start.
    await game.ready('Kbot');
